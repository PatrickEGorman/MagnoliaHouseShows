...
def get_photos_list(request):
    ...
    photo_list = Flier.objects.all()
    date = datetime.datetime.now().date()
    photo_list = photo_list.filter(date__lte=date).order_by('date').reverse()[:num_photos]
...
def get_videos_list(request):
    ...
    video_list = Flier.objects.all()
    date = datetime.datetime.now().date()
    video_list = video_list.filter(date__lte=date).order_by('date').reverse()[:num_videos]
